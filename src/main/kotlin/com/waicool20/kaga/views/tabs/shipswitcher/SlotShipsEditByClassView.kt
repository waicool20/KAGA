...
class SlotShipsEditByClassView : SlotShipsEditByShipClassView<ShipSpecificationByClass.ShipClass>() {
    override val spec = super.spec as ShipSpecificationByClass

    init {
        commonLabel.text = "Select Ship Class:"
        commonComboBox.items.addAll(ShipSpecificationByClass.ShipClass.values())
        commonComboBox.selectionModel.select(spec.shipClass)
    ...
    override fun onSave() {
        ...
        val s = ShipSpecificationByClass(
